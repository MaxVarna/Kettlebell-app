...
const makeStyles = (colors: typeof dark) => StyleSheet.create({
  ...
  addMovementGrid: { minHeight: 280, flexBasis: '48%', flexGrow: 1, alignItems: 'center', justifyContent: 'flex-start', gap: space.xs, paddingHorizontal: space.sm, paddingVertical: space.md, borderRadius: 12, borderWidth: 1, borderColor: 'transparent', backgroundColor: colors.surfaceSoft, position: 'relative' },
  addMovementGridSelected: { borderColor: colors.accent },
  addMovementSelectRow: { position: 'absolute', top: space.xs, right: space.xs, width: 48, height: 48, alignItems: 'center', justifyContent: 'center', zIndex: 1 },
  addMovementCheckboxTarget: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center' },
  addMovementCheckbox: { width: 22, height: 22, alignItems: 'center', justifyContent: 'center', borderRadius: 6, borderWidth: 2, borderColor: colors.faint, backgroundColor: colors.surface },
  addMovementCheckboxChecked: { borderColor: colors.accent, backgroundColor: colors.accent },
  addMovementCheckboxMark: { color: colors.accentText, fontSize: 15, lineHeight: 17, fontWeight: '800' },
