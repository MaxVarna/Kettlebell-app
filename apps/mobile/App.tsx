...
function InteractiveIntro({ colors, animationEnabled, onSkip, onCreate }: { colors: typeof dark; animationEnabled: boolean; onSkip: () => void; onCreate: () => void }) {
  ...
  return <View style={styles.introRunnerScreen}>
    ...
    {animationEnabled && <View style={styles.introVisual}><View style={[styles.introHalo, { borderColor: visual.color, backgroundColor: visual.fill }]} />{step === 'work' ? <IntroWorkVisual /> : step === 'rest' ? <Image source={REST_STANDING_IMAGE} resizeMode="contain" style={styles.introFigure} /> : null}</View>}
