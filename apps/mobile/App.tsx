...
const makeStyles = (colors: typeof dark) => StyleSheet.create({
  ...
  addMovementGrid: { minHeight: 166, flexBasis: '48%', flexGrow: 1, alignItems: 'center', justifyContent: 'flex-start', gap: space.xs, paddingHorizontal: space.sm, paddingVertical: space.md, borderRadius: 12, backgroundColor: colors.surfaceSoft, position: 'relative' },
